...
source_x86_64=("${pkgname}-${pkgver}-x86_64.AppImage::https://github.com/sahilcodexx/zebBrowser/releases/download/zeb-v${pkgver}/zeb_${pkgver}_amd64.AppImage")
source_aarch64=("${pkgname}-${pkgver}-aarch64.AppImage::https://github.com/sahilcodexx/zebBrowser/releases/download/zeb-v${pkgver}/zeb_${pkgver}_aarch64.AppImage")
